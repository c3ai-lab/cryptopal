...
<p>
  ...
  use sokol testnet with the xDai ERC20 token for testing the service. It is compatible
...
<p>
  <a href="https://docs.bluecryptopal.com/howto/howitworks">In this section</a>{" "}
  we describe the idea and technology behind CryptoPal. It gives you insides of
  how CryptoPal is working and why you should use it as your payment provider.
  More information about it can be found on our{" "}
  <a href="https://www.bluecryptopal.com" target="_blank">
    website
  </a>{" "}
  as well.
