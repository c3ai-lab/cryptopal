...
import GetProductResponse from "../components/content/Products/GetProduct/GetProductResponse.js";
...
<Route method="DELETE" path="/products/{product_id}" />

Delete a product permanently, by ID.
